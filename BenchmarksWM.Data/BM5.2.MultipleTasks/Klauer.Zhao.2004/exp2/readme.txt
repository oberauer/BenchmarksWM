...
The Pascal program auswert.pas takes these as input and produces the output file ergebnis.

The file "ergebnis" is also included in SPSS format as the file "data1-24.sav" with variable labels added. It contains percentages of correct responses in the
